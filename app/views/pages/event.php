        ...
        <div class="row g-5 justify-content-center">
                ...
                <div class="events-item bg-primary rounded">
                    <div class="events-inner position-relative">
                        <div class="events-img overflow-hidden rounded-circle position-relative">
                            <img src="<?= url('img/event-1.jpg') ?>" class="img-fluid w-100 rounded-circle" alt="Image">
                            <div class="event-overlay">
                                <a href="<?= url('img/event-1.jpg') ?>" data-lightbox="event-1">
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.3s">
                <div class="events-item bg-primary rounded">
                    <div class="events-inner position-relative">
                        <div class="events-img overflow-hidden rounded-circle position-relative">
                            <img src="<?= url('img/event-2.jpg') ?>" class="img-fluid w-100 rounded-circle" alt="Image">
                            <div class="event-overlay">
                                <!-- FIX: your original HTML linked event-3.jpg here; keep event-2 for consistency -->
                                <a href="<?= url('img/event-2.jpg') ?>" data-lightbox="event-2">
                                    <i class="fas fa-search-plus text-white fa-2x"></i>
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4 wow fadeIn" data-wow-delay="0.5s">
                <div class="events-item bg-primary rounded">
                    <div class="events-inner position-relative">
                        <div class="events-img overflow-hidden rounded-circle position-relative">
                            <img src="<?= url('img/event-3.jpg') ?>" class="img-fluid w-100 rounded-circle" alt="Image">
                            <div class="event-overlay">
                                <a href="<?= url('img/event-3.jpg') ?>" data-lightbox="event-3">
                                    <i class="fas fa-search-plus text-white fa-2x"></i>
                                </a>
                            </div>
                        </div>
