        ...
        <div class="p-5 bg-light rounded">
            ...
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 700px;">
                ...
                <p class="mb-5">
                    ...
                    <a href="https://htmlcodex.com/contact-form" target="_blank" rel="noopener">Download Now</a>.
                </p>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <form action="#" method="post">
                        ...
                        <button class="w-100 btn btn-primary form-control py-3 border-primary text-white bg-primary" type="submit">
                            Submit
                        </button>
                    </form>
                </div>
