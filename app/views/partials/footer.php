        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="footer-item">
                    <h2 class="fw-bold mb-3"><span class="text-primary mb-0">Hello</span><span
                            class="text-secondary">Kidz</span></h2>
                    <p class="mb-4">
                        There cursus massa at urnaaculis estieSed aliquamellus vitae ultrs condmentum
            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="footer-item">
                    ...
                    <div class="row g-3">
                        <?php
                        $gallery = ['galary-1.jpg', 'galary-2.jpg', 'galary-3.jpg', 'galary-4.jpg', 'galary-5.jpg', 'galary-6.jpg'];
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light">
                    <a href="#"><i class="fas fa-copyright text-light me-2"></i>Hello Kidz</a>, All right reserved.
                </span>
            </div>
            <div class="col-md-6 my-auto text-center text-md-end text-white">
                Designed By <a class="border-bottom" href="https://samratkatwal.com.np">Samrat Katwal</a>
            </div>
        </div>
    </div>
</div>
